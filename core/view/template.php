        ...
        <div class="navbar-header">
            ...
            <a href="http://www.creative-tim.com">
                <div class="logo-container">
                    <div class="logo">
                        <img src="<?php echo STYLE_DIR . 'assets/paper_img/new_logo.png'?>" alt="Creative Tim Logo">
                    </div>
                    <div class="brand">
                        Creative Tim
                    </div>
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-xs-8 col-sm-6 col-md-3">
                            <h4>Rounded Image</h4>
                            <img src="<?php echo STYLE_DIR . 'assets/paper_img/thinking_in_textures.png'?>" alt="Rounded Image" class="img-rounded img-responsive">
                            <div class="img-details">
                                <div class="author">
                                    <img src="<?php echo STYLE_DIR . 'assets/paper_img/chet_faker_1.jpg'?>" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                </div>
                                <p>Chet Faker</p>
                            </div>
                        ...
                        <div class="col-xs-6  col-sm-3 col-md-2 col-md-offset-1">
                            ...
                            <img src="<?php echo STYLE_DIR . 'assets/paper_img/placeholder.jpg'?>" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                            <p class="text-center">Placeholder</p>
                        </div>
                        <div class="col-xs-6  col-sm-3 col-md-2 col-md-offset-1">
                            <h4>Thumbnail</h4><br />
                            <img src="<?php echo STYLE_DIR . 'assets/paper_img/chet_faker_2.jpg'?>" alt="Thumbnail Image" class="img-thumbnail img-responsive">
                ...
                <div class="row example-pages">
                    <div class="col-md-4">
                        <a href="examples/landing.html" target="_blank">
                            <img src="<?php echo STYLE_DIR . 'assets/paper_img/examples/landing.jpg'?>" alt="Rounded Image" class="img-rounded img-responsive">
                            <h5>Landing Page</h5>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="examples/register.html" target="_blank">
                            <img src="<?php echo STYLE_DIR . 'assets/paper_img/examples/register.jpg'?>" alt="Rounded Image" class="img-rounded img-responsive">
                            <h5>Register</h5>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="examples/profile.html" target="_blank">
                            <img src="<?php echo STYLE_DIR . 'assets/paper_img/examples/profile.jpg'?>" alt="Rounded Image" class="img-rounded img-responsive">
                            <h5>Profile</h5>
                        </a>
                    </div>
                </div>
